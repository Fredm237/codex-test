...
- [Baseline Hybrid Retrieval Phase 5B](PHASE_5B_HYBRID_RETRIEVAL_BASELINE.md)
- [Benchmark Hybrid Retrieval Phase 5C](PHASE_5C_HYBRID_RETRIEVAL_BENCHMARK.md)
- [Adaptateur lexical Hybrid Retrieval Phase 5D](PHASE_5D_HYBRID_RETRIEVAL_LEXICAL.md)
- [Expansion structurée et sémantique Phase 5E](PHASE_5E_HYBRID_RETRIEVAL_EXPANSION.md)
