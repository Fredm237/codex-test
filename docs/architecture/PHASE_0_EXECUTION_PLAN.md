...
| P0.5 — Product Graph shadow — **EN COURS** | Brand/Family/Model/Variant v0 | Huit tables expand-only, backfill contrôlé, résolution conservative exacte-GTIN et quarantaine livrés localement | Technique : migration/replay/adaptateurs verts ; métier : seuils entity/variant atteints sur test indépendant | Flags off par défaut ; aucun consommateur v2 ; pas de backfill production ; downgrade seulement sur environnement éphémère |
