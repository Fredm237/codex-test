...
| P0.5 — Product/Variant + Offer Graph + Merchant Intelligence + Evidence shadows — **EN COURS** | Brand/Family/Model/Variant/Offer/Merchant/Claim v0 | Douze tables expand-only, backfills contrôlés, résolution exacte-GTIN, preuves offre décimales, compteurs marchands sans score et claims fail-closed livrés localement | Technique : migrations/replay/adaptateurs verts ; métier : seuils entity/variant/attachment/offer truth, qualité marchand, couverture et calibration atteints sur tests indépendants | Flags off par défaut ; aucun consommateur v2 ; aucun claim fort ; pas de backfill production ; downgrade seulement sur environnement éphémère |
