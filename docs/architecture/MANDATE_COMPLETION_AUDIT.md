...
| 28–29 | Observabilité et opérations | **PARTIEL** | Corrélation des huit jalons décisionnels, spans PostgreSQL/Redis/Awin/SerpAPI/LLM, propagation W3C HTTP, probes, métriques, front door, scheduler, alertes locales, OpenMetrics, pack Prometheus/Grafana et activation fail-closed validés ; backend de traces, déploiement agrégateur/dashboard, reçu réel, pager, WAF, CIDR Railway et trafic représentatif manquent |
