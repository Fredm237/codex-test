...
- Référence applicative locale qualifiée : `b1a18f2`
- Référence applicative distante qualifiée : `6a793ac`, arbre commun `2a377adf6808bd5e7eafb6756d8949c2ce0b1e30`
- Référence Quality versionnée : artefact Actions `9737603091`
...
| P0.7 — CI multi-surfaces et protection | `p0_g` | **TERMINÉ** (`p0_g` fait) | Référence distante `6a793ac`, arbre `2a377a…` identique au commit local `b1a18f2` ; PR #385 ; Actions #354 : web/mobile/extension verts, Alembic, régressions backend et readiness verts ; seul le gate strict Quality échoue comme attendu sur les datasets humains vides ; artefact `9737603091` | Workflow backend/contrats/migrations/Quality, web, mobile et extension ; GitHub Actions réel et protection de `main` | [qualification distante](PHASE_0_REMOTE_QUALIFICATION_REPORT.md), [workflow Phase 0](../../.github/workflows/backend-catalog-quality.yml), [reçu Railway](PHASE_0_RAILWAY_DEPLOYMENT_RECEIPT.md) | Lot acquis ; la conclusion globale reste NO-GO parce que le check backend ferme correctement sur les datasets humains vides |
