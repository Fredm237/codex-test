...
| P0.5 — Product/Variant + Offer Graph shadows | `p0_f` | **EN COURS — SHADOWS TECHNIQUES LIVRÉS, GATE HUMAIN ROUGE** | Neuf tables `graph_*`, migrations `8b2f4c7d9a10` + `c6a1d4e8f2b3`, resolver exact-GTIN, argent décimal, stock tri-state, writers Awin isolés et backfills bornés ; backend **2 086 + 2 ignorés** | 76 tests Product/Offer Graph, migration et configuration ciblés ; Quality 377/377 ; readiness stricte exit 1 attendu | [ADR Product Graph](ADR-002-PRODUCT-GRAPH-IDENTITY-SHADOW.md), [ADR Offer Graph](ADR-003-OFFER-GRAPH-EVIDENCE-SHADOW.md), [rapports P0.5](PHASE_0F_PRODUCT_GRAPH_SHADOW_REPORT.md) et [P0.5b](PHASE_0F_OFFER_GRAPH_SHADOW_REPORT.md), [runbook](DATABASE_MIGRATION_RUNBOOK.md) | Aucun backfill ni activation production ; dépend de P0.2 pour mesurer faux merges/splits, relation de variante, attachement et vérité offre sur un holdout indépendant |
