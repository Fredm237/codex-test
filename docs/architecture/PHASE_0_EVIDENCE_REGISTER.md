...
- Référence applicative locale qualifiée : `04fe05b`
- Référence applicative distante qualifiée : `2725a46`, arbre commun `de9cc8944e82f42ae28361f43f5fa49791d6b1e1`
- Référence Quality versionnée : artefact Actions `9736128514`
...
| P0.2 — Quality Lab | `p0_c` | **EN COURS** ; infrastructure v0.5 locale verte, données **NO-GO** | Le roster reste fermé à 7 datasets/27 gates ; 7 moteurs réels sont branchés, dont les résolutions Graph exactes-GTIN ; Quality **377/377** et backend courant **2 091 + 2 ignorés** ; rapport `integrity_valid: true`, `ready: false` | Suites Quality et backend ; readiness normale exit 0 et stricte exit 1 | [inventaire réel](../../quality/candidates/README.md), [manifeste v0.5](../../quality/manifest.json), [rapport de readiness daté](../../quality/reports/readiness-2026-08-29.json), [rapport P0.c](PHASE_0C_QUALITY_REPORT.md) | Curer humainement les candidats, collecter les sept jeux réellement indépendants avec adjudication, provenance, volumes et supports minimaux ; aujourd'hui : **0 cas humains** et aucune régression métier mesurable |
...
| P0.5 — Product/Variant + Offer Graph + Merchant Intelligence shadows | `p0_f` | **EN COURS — SHADOWS TECHNIQUES LIVRÉS, GATE HUMAIN ROUGE** | Dix tables d'expansion, migrations `8b2f4c7d9a10` + `c6a1d4e8f2b3` + `d7b2e5f9a4c1`, resolver exact-GTIN, argent décimal, stock tri-state et compteurs marchands sans score ; backend **2 091 + 2 ignorés** | 81 tests Product/Offer/Merchant, migration et configuration ciblés ; Quality 377/377 ; readiness stricte exit 1 attendu | [ADR Product Graph](ADR-002-PRODUCT-GRAPH-IDENTITY-SHADOW.md), [ADR Offer Graph](ADR-003-OFFER-GRAPH-EVIDENCE-SHADOW.md), [ADR Merchant Intelligence](ADR-004-MERCHANT-INTELLIGENCE-MEASUREMENT-SHADOW.md), [rapports P0.5](PHASE_0F_PRODUCT_GRAPH_SHADOW_REPORT.md), [P0.5b](PHASE_0F_OFFER_GRAPH_SHADOW_REPORT.md) et [P0.5c](PHASE_0F_MERCHANT_INTELLIGENCE_REPORT.md) | Aucun backfill ni activation production ; dépend de P0.2 et de sources après clic/achat pour mesurer faux merges/splits, attachement, vérité offre et qualité marchand |
| P0.6 — Observabilité et front door | `p0_i` | **EN COURS** ; backend Core, probes, identité edge, export direct et capacité volume production verts, agrégation externe encore NO-GO | Déploiement Railway `03be13dc…` actif en EU West : live/ready et `/health` protégé HTTP 200, valeurs `X-Real-IP` forgées écrasées ; OpenMetrics 1.0 qualifié, volume 39,28 %, backups et moniteurs 14/17 GB actifs ; Redis atomique opt-in non activé : **180 ciblés**, backend **2 067 réussis + 2 ignorés** | Readiness publique, route protégée et probes anti-spoofing réelles ; contrat OpenMetrics, audit Railway ; concurrence Redis, panne/plafond, en-tête absent/dupliqué/invalide, séparation derrière un pair, confidentialité, configuration et cycle de vie | [rapport P0.6](PHASE_06_OBSERVABILITY_REPORT.md), [politique front door](FRONT_DOOR_SECURITY_POLICY.md), [reçu OpenMetrics/résilience](PHASE_06_PRODUCTION_OBSERVABILITY_RECEIPT.md), [reçu Railway](PHASE_0_RAILWAY_DEPLOYMENT_RECEIPT.md), [pack agrégateur](../../filon-backend/observability/README.md) | Déployer backend de traces et agrégateur ; activer/tester Redis privé ou WAF ; canal/pager, notification réelle et trafic représentatif restent ouverts |
| P0.7 — CI multi-surfaces et protection | `p0_g` | **TERMINÉ** (`p0_g` fait) | Référence distante `2725a46`, arbre `de9cc8…` identique au commit local `04fe05b` ; PR #385 ; Actions #352 : web/mobile/extension verts, Alembic et régressions backend vertes ; seul le gate strict Quality échoue comme attendu sur les datasets humains vides ; artefact `9736128514` | Workflow backend/contrats/migrations/Quality, web, mobile et extension ; GitHub Actions réel et protection de `main` | [qualification distante](PHASE_0_REMOTE_QUALIFICATION_REPORT.md), [workflow Phase 0](../../.github/workflows/backend-catalog-quality.yml), [reçu Railway](PHASE_0_RAILWAY_DEPLOYMENT_RECEIPT.md) | Lot acquis ; la conclusion globale reste NO-GO parce que le check backend ferme correctement sur les datasets humains vides |
