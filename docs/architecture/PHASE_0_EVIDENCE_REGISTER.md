...
| P0.7 — CI multi-surfaces et protection | `p0_g` | **TERMINÉ** (`p0_g` fait) | Référence applicative distante `5ab3c3c`, arbre `e212470…` identique au commit local `8594bd8` ; PR #385 ; Actions #362 : web/mobile/extension verts, Alembic, 2 124 régressions backend et readiness normale verts ; seul le gate strict Quality échoue comme attendu sur les datasets humains vides ; artefact `9738761749` | Workflow backend/contrats/migrations/Quality, web, mobile et extension ; GitHub Actions réel et protection de `main` | [qualification distante](PHASE_0_REMOTE_QUALIFICATION_REPORT.md), [workflow Phase 0](../../.github/workflows/backend-catalog-quality.yml), [reçu Railway](PHASE_0_RAILWAY_DEPLOYMENT_RECEIPT.md) | Lot acquis ; la conclusion globale reste NO-GO parce que le check backend ferme correctement sur les datasets humains vides |
