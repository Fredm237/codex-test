...
const COPY: Record<Locale, Copy> = {
  fr: {
    path: [["Votre envie", "comprise"], ["Les pièces", "trouvées"], ["Votre tenue", "composée"]],
    eyebrow: "Composez votre tenue",
    title: "Outfit Studio",
    intro: "Dites-nous ce que vous cherchez. FILON parcourt le catalogue et rassemble des pièces qui vont dans la même direction.",
    ...
    submit: "Composer ma tenue",
    thinking: "FILON cherche les pièces qui correspondent…",
    ...
    resultEyebrow: "Votre sélection",
    itemSingular: "article",
    itemPlural: "articles",
    knownTotal: "Total des articles",
    delivery: "Livraison à vérifier",
    confidence: "Qualité des informations",
    style: "Cohérence de la sélection",
    notMeasured: "Non mesuré",
    why: "Pourquoi cette proposition",
    unknowns: "À vérifier",
    noSolution: "Nous n’avons pas encore assez d’informations pour composer une tenue complète.",
    candidates: "articles consultés dans le catalogue",
    ...
    keep: "À garder",
    reject: "Pas pour moi",
    feedbackThanks: "Merci, votre avis nous aide à améliorer les prochaines sélections.",
    discoveryTitle: "Voici déjà des pièces qui correspondent",
    discoveryBody: "Leurs prix sont encore en cours d’actualisation. Vous pouvez néanmoins les découvrir sans attendre.",
  ...
  nl: {
    path: [["Jouw idee", "begrepen"], ["De items", "gevonden"], ["Jouw outfit", "samengesteld"]],
    eyebrow: "Stel je outfit samen",
    title: "Outfit Studio",
    intro: "Vertel ons wat je zoekt. FILON doorzoekt de catalogus en brengt passende items samen.",
    ...
    submit: "Mijn outfit samenstellen",
    thinking: "FILON zoekt passende items…",
    ...
    unavailable: "De zoekopdracht is tijdelijk niet beschikbaar. Probeer het zo opnieuw.",
    resultEyebrow: "Jouw selectie",
    itemSingular: "artikel",
    itemPlural: "artikelen",
    knownTotal: "Totaal van de artikelen",
    delivery: "Levering controleren",
    confidence: "Kwaliteit van de informatie",
    style: "Samenhang van de selectie",
    notMeasured: "Niet gemeten",
    why: "Waarom dit voorstel",
    unknowns: "Te controleren",
    noSolution: "We hebben nog niet genoeg informatie om een volledige outfit samen te stellen.",
    candidates: "catalogusitems bekeken",
    ...
    feedbackThanks: "Bedankt, je feedback helpt ons om volgende selecties te verbeteren.",
    discoveryTitle: "Deze items passen alvast bij je vraag",
    discoveryBody: "De prijzen worden nog bijgewerkt. Je kunt de items ondertussen al bekijken.",
  ...
  en: {
    path: [["Your idea", "understood"], ["The pieces", "found"], ["Your outfit", "composed"]],
    eyebrow: "Compose your outfit",
    title: "Outfit Studio",
    intro: "Tell us what you are looking for. FILON explores the catalogue and brings matching pieces together.",
    ...
    submit: "Compose my outfit",
    thinking: "FILON is finding matching pieces…",
    ...
    resultEyebrow: "Your selection",
    itemSingular: "item",
    itemPlural: "items",
    knownTotal: "Items total",
    delivery: "Delivery to check",
    confidence: "Information quality",
    style: "Selection coherence",
    notMeasured: "Not measured",
    why: "Why this proposal",
    unknowns: "To check",
    noSolution: "We do not have enough information yet to compose a complete outfit.",
    candidates: "catalogue items reviewed",
    ...
    keep: "Keep it",
    reject: "Not for me",
    feedbackThanks: "Thank you. Your feedback helps improve future selections.",
    discoveryTitle: "These pieces already match your request",
    discoveryBody: "Their prices are still being refreshed, but you can explore the pieces now.",
