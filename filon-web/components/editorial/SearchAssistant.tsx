...
const SL = {
  fr: {
    ...
    real: "Preuves du catalogue FILON", est: "Prix estimés, à titre indicatif",
    analysed: "offres vérifiées", forNeed: "pour", verifiedResults: (count: number) => `${count} offre${count > 1 ? "s" : ""} disponible${count > 1 ? "s" : ""} maintenant`,
  ...
  nl: {
    ...
    real: "Bewijs uit de FILON-catalogus", est: "Geschatte prijzen, ter indicatie",
    analysed: "aanbiedingen gecontroleerd", forNeed: "voor", verifiedResults: (count: number) => `${count} aanbieding${count > 1 ? "en" : ""} nu beschikbaar`,
  ...
  en: {
    ...
    real: "Evidence from the FILON catalogue", est: "Estimated prices, for guidance",
    analysed: "offers checked", forNeed: "for", verifiedResults: (count: number) => `${count} offer${count > 1 ? "s" : ""} available now`,
