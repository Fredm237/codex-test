...
const COPY = {
  fr: {
    ...
    scope: {
      ...
      non_recommandee: "Pas assez d’informations pour la recommander",
      tarif_a_verifier: "Tarif de séjour à confirmer",
      conditions_a_verifier: "Conditions à confirmer avant de choisir",
    },
    confidence: { not_calibrated: "Informations incomplètes" },
  ...
  nl: {
    ...
    scope: {
      ...
      non_recommandee: "Nog niet genoeg informatie om dit aan te raden",
      tarif_a_verifier: "Verblijfstarief te bevestigen",
      conditions_a_verifier: "Voorwaarden controleren vóór je kiest",
    },
    confidence: { not_calibrated: "Informatie nog onvolledig" },
  ...
  en: {
    ...
    scope: {
      ...
      non_recommandee: "Not enough information to recommend it yet",
      tarif_a_verifier: "Stay rate to confirm",
      conditions_a_verifier: "Terms to confirm before choosing",
    },
    confidence: { not_calibrated: "Some information is missing" },
