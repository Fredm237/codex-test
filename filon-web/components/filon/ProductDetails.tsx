...
const COPY = {
  fr: {
    plan: "FILON / IDENTITÉ 03", identity: "Identité exacte", currentOffers: "Offres comparables actuelles", comparedMerchants: "Marchands comparés", unknown: "Inconnu", proof: "Preuve et décision",
  ...
  nl: {
    plan: "FILON / IDENTITEIT 03", identity: "Exacte identiteit", currentOffers: "Huidige vergelijkbare aanbiedingen", comparedMerchants: "Vergeleken winkels", unknown: "Onbekend", proof: "Bewijs en beslissing",
  ...
  en: {
    plan: "FILON / IDENTITY 03", identity: "Exact identity", currentOffers: "Current comparable offers", comparedMerchants: "Compared merchants", unknown: "Unknown", proof: "Evidence and decision",
