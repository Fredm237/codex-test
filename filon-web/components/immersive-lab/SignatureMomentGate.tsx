...
import { useAdaptiveFrameBudget } from "@/components/experience/signature/ImmersiveRuntime";
import styles from "@/components/experience/signature/signature-commerce.module.css";

const SignatureCommerceCanvas = dynamic(
  () => import("@/components/experience/signature/SignatureCommerceCanvas").then((module) => module.SignatureCommerceCanvas),
