...
function CashbackBody({ t, faq }: { t: {
  plan: string; eyebrow: string; title: ReactNode; intro: string;
...
const FR = {
  plan: "FILON / DÉCISION 02", eyebrow: "Cashback",
...
const NL = {
  plan: "FILON / BESLISSING 02", eyebrow: "Cashback",
...
const EN = {
  plan: "FILON / DECISION 02", eyebrow: "Cashback",
