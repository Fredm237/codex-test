...
function ScoreBody({ t }: { t: {
  ...
  plan: string; total: string; idx: string; h2a: string; h2b: string; criteria: Array<[string, string, string]>;
      ...
      <section className="p19-decision-hero">
        <div className="ed-wrap p19-decision-hero-grid">
          <div className="p19-decision-copy">
            <p className="p19-decision-plan">{t.plan}</p>
...
const FR = {
  plan: "FILON / DÉCISION 01", total: "100 points mesurables",
...
const NL = {
  plan: "FILON / BESLISSING 01", total: "100 meetbare punten",
...
const EN = {
  plan: "FILON / DECISION 01", total: "100 measurable points",
